    ...
    <>
        <div className="container my-5 py-5">
          ...
          <div className="col-md-6 my-1 text-center">
               <img src={americana1} alt="" className={`${styles.imgSizeProj}`}/> 
            </div>
            <div className="col-md-6 my-1 text-center">
               <img src={americana2} alt="" className={`${styles.imgSizeProj}`}/> 
            </div>
            <div className="col-md-6 my-1 text-center">
               <img src={americana3} alt="" className={`${styles.imgSizeProj}`}/> 
            </div>
            <div className="col-md-6 my-1 text-center">
               <img src={americana4} alt="" className={`${styles.imgSizeProj}`}/> 
            </div>
          </div>
        </div>
